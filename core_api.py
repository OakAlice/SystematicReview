...
class Identifier:
    identifier: str
    type: str  # assuming same structure for identifiers
...
class Reference:
    ...
    id: int
    raw: str
    title: str  # assuming same structure for references

@dataclass
class CoreFindResult:
    acceptedDate: str
    arxivId: Optional[str]
    authors: List[str]
    citationCount: Optional[int]
    contributors: List[str]
    outputs: Optional[str]  # I've added a string as a placeholder; adjust if needed
    createdDate: str
    dataProviders: List[str]
    depositedDate: str
    abstract: str
    documentType: str
    doi: str
    ...
    title: str
    language: Dict[str, Union[str, int]]  # Update this with appropriate structure
    magId: Optional[int]
    oaiIds: List[str]
    publishedDate: str
    publisher: Dict[str, Union[str, int]]  # Update this with appropriate structure
...
class CoreClient:
    ...
    def find(self, query: Union[str, tuple]="", entity="works", recent=False, limit=10, offset=0,
